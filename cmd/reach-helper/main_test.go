...
// The agent is the only thing reach ever writes to a target, and it parses
...
// that leaves debris behind breaks the promise that reach's footprint on a
...
// sense that reach does not want a corrupt stream turning into a huge
