...
// operating systems reach runs on. Nothing else in the program branches on
...
// reach recognises that it is being run as a shim.
...
// upgrading reach in place changes what the link resolves to.
