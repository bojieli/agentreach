...
// Environment handling, which is one of the two places waldo's Unix assumptions
...
// launched with waldo's shim directory absent from its search path, find the
...
// between them, and which one a child process sees is not something waldo
